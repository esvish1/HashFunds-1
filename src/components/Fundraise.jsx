      ...
      <div>
        <div>
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
            <img
              style={{ position: "absolute", width: "1540px", height: "480px" }}
              src={img2}
              alt="My image"
            />

            <div class="absolute top-40 left-40 px-0 py-9">
              <h1 class="mb-3 text-xl-300 font-semibold tracking-tight text-white">
                Start Fundraising
              </h1>
                ...
                <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                  <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:dark:bg-gray-700">
                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-[#00d8ff]">
                      ...
                      <p className="mt-3">
                        It’ll take only 2 minutes. Just tell us a few details
                        about you and the ones you are raising funds for and
                    ...
                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-[#00d8ff]">
                      ...
                      <p className="mt-3">
                        - Two Goverment ID Proof <br />- Presciption from
                        Consulting Doctor <br />- Consulting Hospital Details{" "}
                        <br />- Medical History of Paitent
                      </p>
                    </div>
                    <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-[#00d8ff]">
                      <h3 className="text-xl font-semibold tracking-wide">
                      ...
                      <p className="mt-3">
                        All you need to do is share the fundraiser with your
                        friends and family. In no time, support will start
                        pouring in.
                      </p>
                    </div>
                  </div>
        ...
        //Footer//
        <hr
          style={{ position: "absolute", top: "2300px", width: "1519px" }}
          className="styled-line"
        />
        <div style={{ position: "absolute", top: "2300px", left: "100px" }}>
        ...
        <div style={{ position: "absolute", top: "2500px", left: "80px" }}>
